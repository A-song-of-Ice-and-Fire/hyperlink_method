...
class CollaborativeFilter(Intensifier):
    def __init__(self,raw_indicator_abb:str="NNAA"):         
        super().__init__(raw_indicator_abb)        
    def train(                                  # 该方法用来生成分数矩阵
        ...
        self.scores_matrix = adj_matrix @ self.raw_matrix + (adj_matrix @ self.raw_matrix).T
